                ...
                {({ matches }) => (
                    <>
                        {matches ? (
                            ...
                            <div className={`${classes.mobileContainer} bg-white rounded-md p-4`}>
                                {isLanguage.company.profile.map((c) => (
                                    <div className={classes.company} key={c.id}>
                                        <div className={classes["mobile-company-title"]}>
                                            {c.title}
                                        </div>
                                        <div className={classes["mobile-company-content"]}>
                                            {c.desc.map((d) => (
                                ...
                                <div className={`${classes.company} my-6`}>
                                    ...
                                    <div className={classes["mobile-company-content"]}>
                                        {isLanguage.company.business.desc.map((b) => (
                                            <div
                            ...
                            <div className="mt-4 d-flex flex-wrap">
                                ...
                                <div className="col-4">
                                    <div className={classes["mobile-small-gallery-company"]}>
